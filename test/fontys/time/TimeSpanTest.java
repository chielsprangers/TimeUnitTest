...
public class TimeSpanTest {
    ...
    TimeSpan tsTest = new TimeSpan(testTime2, testTime1);
    

    public TimeSpanTest() {
        try {
            TimeSpan tsTestBeginTime = new TimeSpan(testTime1, testTime2);
    ...
    public void testGetBeginTime() {
        assertEquals("Moet gelijk zijn aan testTime", testTime2, tsTest.getBeginTime());
    }
    ...
    public void testSetBeginTime() {
        ...
        try {
            TimeSpan tsTestBeginTime = tsTest;
    ...
    public void testUnionWith() {
        ...
        tsTimeSpanTest = new TimeSpan(testTime2Test,testTime1Test);
